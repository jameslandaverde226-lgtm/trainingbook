        ...
        <div className="p-5 lg:p-8 flex flex-col items-center w-full">
            ...
            <div className="flex lg:flex-col items-center gap-5 w-full">
                ...
                <div className="flex-1 min-w-0 flex flex-col lg:items-center">
                    <h2 className="text-xl lg:text-3xl font-[900] text-slate-900 tracking-tight lg:text-center leading-none mb-1.5 truncate">{member.name}</h2>
            ...
            <div className="w-full mt-6 lg:mt-8 grid grid-cols-1 gap-3">
                ...
                <div className="grid grid-cols-2 gap-2 w-full">
                    <div className="flex items-center gap-2 px-3 py-2.5 bg-slate-50 border border-slate-100 rounded-xl">
                        ...
                        <span className="text-[9px] font-bold text-slate-600 truncate">{member.email?.split('@')[0] || "No Email"}</span>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-2.5 bg-slate-50 border border-slate-100 rounded-xl">
